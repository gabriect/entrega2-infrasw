Entrega 2 do projeto de Infraestrutura de Software. Ambos os códigos foram feitos na linguagem JAVA e a proposta era utilizarmos de threads e do conceito de concorrência.
